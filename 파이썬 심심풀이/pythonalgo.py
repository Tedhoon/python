...
spans = soup.findAll('span' , {"class" : "addr"})
print(spans)
...
#                             at_name.append(i.text)
#                             total[i.text]=v.text

#     req_address= requests.get("https://m.search.naver.com/search.naver?sm=mtp_hty.top&where=m&query="+i.text)
#     html2 = req_address.text
